package com.cemerlang.ataraxia.ui.community
...
import com.cemerlang.ataraxia.data.models.community.Comment
import com.cemerlang.ataraxia.data.models.community.PostData
import com.cemerlang.ataraxia.databinding.ActivityCommunityPostBinding
import com.cemerlang.ataraxia.databinding.SheetCommentBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            post?.let { postData ->
                ...
                if (likeByUser) btnLike.background.setTint(getColor(R.color.ungu_tua_100))
                ...
                btnLike.setOnClickListener {
                    ...
                    if (!likeByUser) {
                        ...
                        btnLike.background.setTint(getColor(R.color.ungu_tua_100))
                    } else {
                        txtLike.text = "${count - 1} suka"
