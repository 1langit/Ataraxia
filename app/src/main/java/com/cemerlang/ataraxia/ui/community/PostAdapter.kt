...
import com.cemerlang.ataraxia.databinding.ComponentCommunityBinding
    ...
    inner class ItemPostViewHolder(private val binding: ComponentCommunityBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(post: PostData) {
            with(binding) {
                ...
                if (post.isLiked) btnLike.background.setTint(ContextCompat.getColor(context, R.color.ungu_tua_100))
